...
LIST_OF_COUNTRY_OPTIONS = json.loads(
    requests.get("https://raw.githubusercontent.com/OpenBB-finance/MacroDatabase/master/Curated/Countries/"
                 "list_of_options.json").text)

LIST_OF_STATES_OPTIONS = json.loads(
    requests.get("https://raw.githubusercontent.com/OpenBB-finance/MacroDatabase/master/Curated/States/"
                 "list_of_options.json").text)
